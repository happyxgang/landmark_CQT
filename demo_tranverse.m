...
% % 初始化指纹库数组 
 ...
 global Parameters;
 params={'f_sd','a_dec','maxpksperframe','hpf_pole','target_df','target_dt','use_bp','duration','maxespersec'};
 default_value={20,0.995,30,                     0.98,      31,             63,         1,            0,            20};
 Parameters = containers.Map(params, default_value);
